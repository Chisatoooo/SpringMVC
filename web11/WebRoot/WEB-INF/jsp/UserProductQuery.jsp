 ...
 %>
  ...
  <body>
  	...
  	<form id="form1" action="userQueryProduct.action" method="post" onsubmit="return checkData()">
  		<input id="querytext" type="text" name="producttext" autocomplete="off" value="<%=producttext %>" placeholder=" 请输入您喜欢的商品信息 （以价格降序排列）"/>
   ...
   <form id="next" action="userNextQueryProductPage.action" method="post">
       <input id="nextpage" class="page" type="submit" value=<%=nextPage %>>
   </form>
   <label id="number"><%=currentPage %>/${allPage}</label>
   <form id="previous" action="userPreviousQueryProductPage.action" method="post">
